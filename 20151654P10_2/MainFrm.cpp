...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	//화면 분할에서 가장 중요한 부분. 표시되는건 두번째의 0, 1 순서대로 나옴
	m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(300, 300), pContext);
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CMy20151654P10_2View), CSize(600, 300), pContext);

	return TRUE;
	// return CFrameWndEx::OnCreateClient(lpcs, pContent);
}
